      ...
      {template && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 flex max-h-[92vh] w-full max-w-3xl flex-col overflow-hidden rounded-2xl border border-dark/10 bg-bg shadow-2xl"
          ...
          >
            <div className="flex items-start justify-between gap-4 border-b border-dark/8 px-6 py-5 sm:px-8">
              <div>
                ...
                <h2
                  ...
                  className="text-[22px] font-extrabold text-dark sm:text-[26px]"
                >
                  {template.name}
                </h2>
                <p className="mt-1 text-[13px] text-dark/50">
                  ...
                  <span className="font-mono text-[12px]">{template.width}×{template.height}</span>
                </p>
              </div>
              <button
                type="button"
